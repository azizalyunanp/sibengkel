...
<table id="dynatable" class="table table-striped table-bordered table-hover">
			...
			?>
				...
				<td><input type="number" class="form-control" id="cr_hrg_brg_<?php echo $b->id;?>" style="width: auto;" placeholder="harga"> </td>
				<td><?php echo $b->stok; ?></td>
				<td><input type="number" class="form-control" style="width: auto;" name="qty" id="cr_qty_<?php echo $b->id;?>" placeholder="jumlah beli"></td>
				<td><button type="button" class="btn btn-success" onclick="add_tt(<?php echo $b->id;?>)"><i class="fa fa-plus"></i> Tambah</button></td>
